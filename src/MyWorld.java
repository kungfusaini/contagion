...
public class MyWorld extends Application {
    ...
    private HBox buttons() {
        ...
        populationS.valueProperty().addListener(new ChangeListener<Number>() {
        ...
        playB.setOnAction(new EventHandler<javafx.event.ActionEvent>() {
            @Override
        ...
        stopB.setOnAction(new EventHandler<javafx.event.ActionEvent>() {
            @Override
            public void handle(javafx.event.ActionEvent event) {
                collisionChecker.suspend();
                Person.pauseAll();
